...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -500, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 2000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -250, length = 8, spread = 3, target = false},
	{name ="combat", interval = 2000, chance = 12, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -200, length = 7, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	{name ="combat", interval = 2000, chance = 8, type = COMBAT_DEATHDAMAGE, minDamage = 0, maxDamage = -250, radius = 4, target = false}
}
